...
public class ReportGenerator {
    ...
    public ReportGenerator(StatisticsProcessor statisticsProcessor,
    ...
    public String generateReport() {
        ...
        appendLine(report, INC_SEQUENCE_LABEL, sequenceProcessor.findLongestIncreasingSequence());
        appendLine(report, DEC_SEQUENCE_LABEL, sequenceProcessor.findLongestDecreasingSequence());
